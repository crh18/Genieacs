apt-get update 
apt-get upgrade 
#apt-get install perl libnet-ssleay-perl openssl libauthen-pam-perl libpam-runtime libio-pty-perl apt-show-versions python libmysqlclient-dev mysql-server mysql-client
#cd /usr/src 
